// https://github.com/kevacoin/bips/blob/master/bip-0021.mediawiki
// kevacoin:<address>[?amount=<amount>][?label=<label>][?message=<message>]

var qs = require('qs')

function decode (uri, urnScheme) {
  urnScheme = urnScheme || 'kevacoin'
